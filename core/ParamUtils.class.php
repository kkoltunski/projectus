...
//user defined
    ...
    {
        $searchForm->selectedTown = ParamUtils::getFromRequest('townSelect');
        $searchForm->selectedVoivodeship = ParamUtils::getFromRequest('voivodeshipSelect');
        $searchForm->selectedSpecialization = ParamUtils::getFromRequest('specializationSelect');
    }
}
